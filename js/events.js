...
var swiper_html = '<div class="c1-list1 clearfix"> <div class="c1-list1-l"> <div class="swiper-container3"> <div class="swiper-wrapper"> <div class="swiper-slide slide-c1-s2  slide-s2-1" data-q="" data-aft=""> <div class="slide-c1-s2-head">Кому?</div> <div class="c1-l1-item  c1-l2-i1"> <h3>Действующему&nbsp;<br class="c2-br2-768">бизнесу&nbsp;</h3> <p>Предпринимателям и компаниям в&nbsp; <br>сфере розничной и промышленной&nbsp; <br>торговли, услуг, консалтинга, B2B&nbsp; <br>и интернет бизнеса.&nbsp;</p> <div class="c1-l1-item-helper"></div> </div> </div> <div class="swiper-slide slide-c1-s2 slide-s2-2" data-q="" data-aft=""> <div class="slide-c1-s2-head">Зачем?</div> <div class="c1-l1-item c1-l2-i3"> <h3>Увеличение&nbsp;<br class="c2-br2-768">продаж&nbsp;</h3> <p>Для&nbsp;взаимодействия&nbsp;с&nbsp;максимально&nbsp; <br class="c2-br1-768">точной ЦА которая будет покупать&nbsp;<br class="c2-br2-768"/> <br class="c2-br1-768">Ваши товары/услуги на 30% больше&nbsp; <br class="c2-br1-768">благодаря актуальному предложению.&nbsp;</p> <div class="c1-l1-item-helper"></div> </div> </div> <div class="swiper-slide slide-c1-s2 slide-s2-3" data-q="" data-aft=""> <div class="slide-c1-s2-head">Следствие</div> <div class="c1-l1-item c1-l2-i5"> <h3>Перекрытие&nbsp;<br class="c2-br2-768">утечки денег&nbsp;</h3> <p>Вы сохраните до 58% прибыли которую&nbsp; <br class="c2-br1-768">Вы теряете каждый день недополучая&nbsp; <br class="c2-br1-768">десятки заявок от Ваших потенциальных&nbsp; <br class="c2-br1-768">клиентов готовых заплатить Вам деньги.&nbsp;</p> <div class="c1-l1-item-helper"></div> </div> </div> </div> <div class="swiper-pagination"></div> </div> </div> <div class="c1-list1-r"> <div class="swiper-container4"> <div class="swiper-wrapper"> <div class="swiper-slide slide-c1-s2  slide-s2-1" data-q="" data-aft=""> <div class="slide-c1-s2-head">Кому?</div> <div class="c1-l1-item c1-l2-i2"> <h3>Начинающему бизнесу</h3> <p>Начинающим предпринимателям, <br>которым важно максимально быстро <br>и эффективно запустить свою идею, <br>а так же извлечь первую прибыль.</p> <div class="c1-l1-item-helper1"></div> </div> </div> <div class="swiper-slide slide-c1-s2 slide-s2-2" data-q="" data-aft=""> <div class="slide-c1-s2-head">Зачем?</div> <div class="c1-l1-item c1-l2-i4"> <h3>Получение первой прибыли</h3> <p>Для быстрого тестирования и анализа&nbsp; <br class="c2-br1-768">спроса в нише, а так же для бюджетного&nbsp; <br class="c2-br1-768">запуска бизнес идеи которая позволит&nbsp; <br class="c2-br1-768">получить клиентов уже на второй день.</p> <div class="c1-l1-item-helper1"></div> </div> </div> <div class="swiper-slide slide-c1-s2 slide-s2-3" data-q="" data-aft=""> <div class="slide-c1-s2-head">Следствие</div> <div class="c1-l1-item c1-l2-i6"> <h3>Снятие рисков провала</h3> <p>В результате запуска Вашей бизнес идеи&nbsp; <br class="c2-br1-768">Вы отсечете все риски провала, а так же&nbsp; <br class="c2-br1-768">сохраните свои деньги для дальнейшего&nbsp; <br class="c2-br1-768">и эффективного масштабирования.</p> <div class="c1-l1-item-helper1"></div> </div> </div> </div> <div class="swiper-pagination"></div> </div> </div> </div>';
  ...
  var swiper3 = new Swiper('.swiper-container3', {
    ...
    breakpoints: {
      767: {
        ...
        paginationClickable: true,
        onInit: function() {
          $('.swiper-container3').find('.swiper-pagination-bullet').first().next().click();
        },
  ...
  var swiper4 = new Swiper('.swiper-container4', {
    ...
    breakpoints: {
      767: {
        ...
        paginationClickable: true,
        onInit: function() {
          $('.swiper-container4').find('.swiper-pagination-bullet').first().next().click();
        },
        onSlideChangeEnd: function() {
...
$('.s2-oto-head').on('click', function() {
  var show_div = $(this).next();
  if (show_div.hasClass('s2-oto-item-active')) {
    show_div.removeClass('s2-oto-item-active').slideUp(150);
    $(this).removeClass('s2-oto-head-active');
  } else {
    $('.s2-oto-head').removeClass('s2-oto-head-active');
    $('.s2-oto-item-hide').removeClass('s2-oto-item-active').slideUp(1);
    $(this).next().slideDown(150, 'linear').toggleClass('s2-oto-item-active');
    $(this).addClass('s2-oto-head-active');
  }
});
...
$('.s1-oto-btn, .s2-oto-btn').on('click', function(e) {
  e.preventDefault();
  $('.modal-tint').addClass('modal-tint-active popup-active');
  $('body').addClass('body-scroll-hide');
  $('.payment').css('display', 'table-cell');
});
...
$(".calc1-phone, .case1-s3-phone, .case1-s7-phone, .case1-s8-phone, .details-phone, .call-phone, .calc-phone, .statem-phone, .payment-phone").keydown(function (event) {
