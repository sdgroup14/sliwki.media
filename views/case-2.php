...
<video autoplay="" loop="" muted="" class="video"><source src="video/video-slivkimedia.mp4" type="video/mp4"></video>
  <div class="container">
    ...
    <div class="header-content">
      <h1>Лендинг Пейдж для&nbsp;бизнеса с&nbsp;гарантией<br class="br-first">&nbsp;потока&nbsp;заявок<br class="br-second">&nbsp;от&nbsp;3&nbsp;до&nbsp;<span class="header-underline">80</span>&nbsp;ежедневно</h1>
      <p>Узнайте&nbsp;сколько&nbsp;клиентов<br class="br-third"> Вы&nbsp;получите&nbsp;в&nbsp;следующем&nbsp;месяце</p>
...
<section class="case1-s2">
  <div class="container">
    <h2 class="section-h2"><span class="u1">Ком</span>у и зачем нужен Лендинг Пейдж?</h2>
      ...
      <div class="c1-list1 clearfix">
        ...
        <div class="c1-l1-item c1-l2-i2">
          ...
          <p>Начинающим предпринимателям,<br>которым важно максимально быстро<br>и эффективно запустить свою идею,<br>а так же извлечь первую прибыль.</p> </div>
        <div class="c1-l1-item c1-l2-i3">
          <h3>Увеличение продаж</h3>
          <p>Для взаимодействия с максимально<br>точной ЦА которая будет покупать<br>Ваши товары/услуги на 30% больше<br>благодаря актуальному предложению.</p> </div>
        <div class="c1-l1-item c1-l2-i4">
          <h3>Получение первой прибыли</h3>
          <p>Для быстрого тестирования и анализа<br>спроса в нише, а так же для бюджетного<br>запуска бизнес идеи которая позволит<br>получить клиентов уже на второй день.</p>
        </div>
        <div class="c1-l1-item c1-l2-i5">
          <h3>Перекрытие утечки денег</h3>
          <p>Вы сохраните до 58% прибыли которую<br>Вы теряете каждый день недополучая<br>десятки заявок от Ваших потенциальных<br>клиентов готовых заплатить Вам деньги.</p>
        </div>
        <div class="c1-l1-item c1-l2-i6">
          <h3>Снятие рисков провала</h3>
          <p>В результате запуска Вашей бизнес идеи<br>Вы отсечете все риски провала, а так же<br>сохраните свои деньги для дальнейшего<br>и эффективного масштабирования.</p> </div>
      </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="case1-s4-list clearfix">
      ...
      <div class="c1-s4-item c1-s4-i6">
        <h3>Получите 20+ бизнес-кейсов</h3>
    ...
    <div class="c1-s9-list">
      <div class="c1-s9-l-item">
        ...
        <div class="c1-s9-item-hide c1-s9-item-active">
          <p>Landing Page — это отдельная страница, разработанная под конкретное торговое предложение.<br>Эта страница содержит всю необходимую информацию для того, чтобы пользователь смог<br>принять решение в пользу именно вашего товара или услуги.</p>
        </div>
      </div>
      <div class="c1-s9-l-item">
        <h3 class="c1-s9-head">Что я получу, заказав лендинг?</h3>
        <div class="c1-s9-item-hide">
          <p>Заказав лендинг, вы получите действенный современный инструмент с отличными скриптами<br>продаж, целым арсеналом инструментов для мотивации покупателей, который 24 часа в сутки<br>каждый день будет рассказывать историю вашего бренда/продукта и приводить вам новых<br>клиентов пока вы занимаетесь другими делами. Попав на ваш лендинг с рекламного объявления,<br>пользователь увидит именно то, что искал.</p>
        </div>
      </div>
      <div class="c1-s9-l-item">
        <h3 class="c1-s9-head">Каким образом осуществляются продажи через одностраничник?</h3>
        <div class="c1-s9-item-hide">
          <p>Основная задача заказа landing page состоит в конвертации посетителя в клиента. Вся страница<br>направлена на то, чтобы пользователь оформил подписку, оставил заявку или заказал звонок.<br>Конверсия – показатель, который подсчитывается на основе действий пользователей на сайте,<br>и именно этот процент позволяет маркетологам выявить насколько успешной была реклама.</p>
        </div>
      </div>
      <div class="c1-s9-l-item">
        <h3 class="c1-s9-head">Какие преимущества я получу при создании лендинг пейдж?</h3>
        <div class="c1-s9-item-hide">
          <p>Создание landing page — выгодная услуга для предпринимателей. Создавая landing page вы<br>получаете следующие преимущества:</p>
          <ul>
            ...
            <li>Landing Page содержит в себе всю необходимую информацию о товаре или услуге, которая способна<br>заинтересовать пользователя в рамках одной страницы, без дополнительных ссылок и переходов.</li>
            <li>Landing Page осуществляет сбор контактов посетителей, пополняя вашу базу потенциальных клиентов,<br>с которыми в последствии могут связаться ваши менеджеры, предложить дополнительные услуги<br>и произвести рассылку с информацией о предстоящей акции.</li>
            <li>Работа 24 часа в сутки.</li>
          </ul>
        </div>
      </div>
      <div class="c1-s9-l-item">
        <h3 class="c1-s9-head">Что даёт разработка посадочных страниц?</h3>
        <div class="c1-s9-item-hide">
          ...
          <ul>
            ...
            <li>Посадочные страницы воспринимаются лучше, благодаря минимуму текста и максимуму<br>графического наполнения.</li>
            <li>В сравнении с сайтами прошлого поколения, качественная посадочная страница даёт<br>увеличение продаж на 15-30 %.</li>
            <li>С помощью А/В тестирования можно шлифовать и совершенствовать страницу,<br>увеличивая показатели эффективности на 5-17 %.</li>
          </ul>
        </div>
      </div>
      <div class="c1-s9-l-item">
        <h3 class="c1-s9-head">Для чего необходимо создание продающей страницы?</h3>
        <div class="c1-s9-item-hide ">
          <p>Многие интересуются, зачем им необходимо создавать продающую страницу, если уже есть<br>готовый сайт. Создание продающей страницы – это не очередное веяние моды, а must have<br>для тех, кому нужен мощный рабочий инструмент для увеличения продаж.<br>Ни один инструмент-маркетинга не сравнится с этой задачей.</p>
        </div>
      </div>
      <div class="c1-s9-l-item">
      ...
      <div class="c1-s9-l-item">
        <h3 class="c1-s9-head">Каковы условия сотрудничества?</h3>
        <div class="c1-s9-item-hide">
          <p>Мы работаем по договору с соблюдением регламентированных объемов работ<br>и сроков реализации.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container clearfix">
    <div class="c1-s11-item c1-s11-i1">
      <div class="c11-slider-wrap">
        ...
        <div class="c1-s11-down">
          <h3>Веб-аналитика</h3>
          <p>Мы никогда не ориентируемся на свое или чужое экспертное<br>мнение, не подкрепив его сначала аналитическими выводами,<br>полученными после исследования вашей ниши и аудитории.</p>
    ...
    <div class="c1-s11-item c1-s11-i2">
      <div class="c11-slider-wrap">
        ...
        <div class="c1-s11-down">
          <h3>Брендинг</h3>
          <p>Образ, который запомнят и будут ассоциировать только с вами<br>для нас это не только айдентика, это важный визуальный язык<br>для коммуникации по всем каналам. Это масштабно, когда одна<br>идеология прослеживается на всех рекламных носителях.</p>
          <a href="" class="c1-s11-btn">Подробнее</a>
        </div>
      </div>
    </div>
    <div class="c1-s11-item c1-s11-i3">
      <div class="c11-slider-wrap">
        ...
        <div class="c1-s11-down">
          ...
          <p>Ваша уникальность, аналитика конкурентной среды, а так же<br>рекламная стратегия позволят определить наилучшие каналы,<br>по которым мы предложим вам рассказать о своем продукте.</p>
          <a href="" class="c1-s11-btn">Подробнее</a>
        </div>
      </div>
    </div>
    <div class="c1-s11-item c1-s11-i4">
      <div class="c11-slider-wrap">
        ...
        <div class="c1-s11-down">
          <h3>Лендинг пейдж</h3>
          <p>Продукт за которым будут выстраиваться клиенты в очередь,<br>для нас это результат безупречного маркетинга и раскрытие<br>скрытых смыслов вашего продукта на продающей странице.</p>
          <a href="" class="c1-s11-btn">Подробнее</a>
        </div>
      </div>
    </div>
