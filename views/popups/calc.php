<div class="popup calc">
  ...
  <p>Внесите свои данные, чтобы заказать расчет<br/>стоимости лендинг пейдж</p>
  ...
  <form action="https://forms.amocrm.ru/queue/add" method="POST" target="hidden_iframe" onsubmit="submitted=true;">
    ...
    <input type="text" id="fields[944881_1]" class="popup-input calc-phone" placeholder="+380 1234567890" required/>
