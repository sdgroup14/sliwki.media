<div class="popup calc">
    ...
    <label for="" class="popup-inp-ico popup-inp-ico-name"><input type="text" id="fields[name_1]" class="popup-input calc-name" placeholder="Ваше имя"></label>
		<input type="text" id="fields[944881_1]" class="popup-input calc-phone" placeholder="+380 1234567890">
