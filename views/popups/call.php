<div class="popup call">
	...
	<p>Внесите свои данные, чтобы заказать&nbsp;<br class="c2-br2-768">звонок</p>
  ...
  <form action="https://forms.amocrm.ru/queue/add" method="POST" target="hidden_iframe" onsubmit="submitted=true;">
    <label for="" class="popup-inp-ico popup-inp-ico-name"><input type="text" id="fields[name_1]" class="popup-input call-name" placeholder="Ваше имя"></label>
		<input type="text" class="popup-input call-phone" id="fields[944881_1]" placeholder="+380 1234567890">
    ...
    <button type="submit" id="button_submit" class="popup-btn pop-call">Заказать звонок</button>
    <input type="hidden" id="amoform_iframe_lang" value="ru">
    <input id="visitor_uid" type="hidden" name="visitor_uid" value="54b4972d-e9d2-42f9-b21d-9bd206826c3a">
  </form>
	<a href="" class="modal-close-dwn close-call">закрыть</a>
</div>