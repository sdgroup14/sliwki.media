<div class="popup payment">
    ...
    <form action="https://forms.amocrm.ru/queue/add" method="POST" target="hidden_iframe" onsubmit="submitted=true;">
	    <label for="" class="popup-inp-ico popup-inp-ico-name"><input type="text" id="fields[name_1]" class="popup-input payment-name" placeholder="Ваше имя" required/></label>
			...
			<input type="text" class="popup-input payment-phone" id="fields[944881_1]" placeholder="+380 1234567890" required/>
	    ...
	    <button type="submit"  id="button_submit" class="popup-btn pop-payment">Оставить заявку</button>
	    <input type="hidden" id="amoform_iframe_lang" value="ru"/>
	    <input id="visitor_uid" type="hidden" name="visitor_uid" value="54b4972d-e9d2-42f9-b21d-9bd206826c3a"/>
		</form>
	<a href="javascript:void(0);" class="modal-close-dwn close-payment">закрыть</a>
</div>